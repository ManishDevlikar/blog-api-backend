...
public class SecurityConfig {
	...
	public static final String[] PUBLIC_URL = { "/api/auth/**", "/v3/api-docs", "/v2/api-docs", "/swagger-resorces/**",
			"/swagger-ui/**", "/webjars/**" };
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf -> csrf.disable())
				.authorizeHttpRequests(
						request -> request.requestMatchers("/test").authenticated().requestMatchers(PUBLIC_URL)
